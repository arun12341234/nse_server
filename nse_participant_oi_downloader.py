...
class NSEAPIDownloader:
    ...
    def download_participant_oi(self, date, output_file=None):
        """
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                # Determine output filename
                if output_file is None:
                    output_file = f"participant_oi_{dt.strftime('%Y%m%d').upper()}.csv"
                output_dir = "./NSE_Downloads/FO_Participant_OI"
                import os
...
def main():
    ...
    # df2 = downloader.download_participant_oi("24-Nov-2025")
    # print(df2)
